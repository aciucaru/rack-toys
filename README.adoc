...
It is necessay that the individual synth voices have an internal envelope (like a ADSR envelope) because, otherwise, the polyphonic synthesizer using those voices will sound bad when multiple notes are playing at the same time.
