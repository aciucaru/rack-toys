= split-setting branch

This branch is made in order to split the single file (and sigle class) that contains all the settings into multiple classes
and files for settings.
